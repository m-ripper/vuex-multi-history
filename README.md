...
1.  Install the dependencies: \
    ...
    > **INFO if using a CDN**:
    >   
    > Replace `<version>` with an available npm-version of `vuex-multi-history` >= `2.0.1`.\
     The root of this module will be available via `window.VuexMultiHistory` and `VuexMultiHistory`.
